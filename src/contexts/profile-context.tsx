...
type EditableProfileFields = Pick<Profile, 'name' | 'avatarSeed'>;

type ProfileContextValue = {
    profile: Profile;
    updateProfile: (editedFields: EditableProfileFields) => void;
};
...
export function ProfileProvider({ children }: { children: ReactNode }) {
    ...
    const updateProfile = useCallback((editedFields: EditableProfileFields) => {
